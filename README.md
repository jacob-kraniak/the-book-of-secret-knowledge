...
- [Active Development Branch: JK_Revisions](#active-development-branch-jk_revisions)
- [Fork Attribution & My Contributions](#fork-attribution--my-contributions)
- [Repository Contents](#repository-contents)
  - [Quick Access](#quick-access)
      - [:black_small_square: SSL](#black_small_square-ssl)
      - [:black_small_square: Security](#black_small_square-security)
      - [:black_small_square: Auditing Tools](#black_small_square-auditing-tools)
      - [:black_small_square: System Diagnostics/Debuggers](#black_small_square-system-diagnosticsdebuggers)
      - [:black_small_square: Databases](#black_small_square-databases)
      - [:black_small_square: TOR](#black_small_square-tor)
      - [:black_small_square: Messengers/IRC Clients](#black_small_square-messengersirc-clients)
      - [:black_small_square: Productivity](#black_small_square-productivity)
      - [:black_small_square: Other](#black_small_square-other)
    - [GUI Tools &nbsp<sup>[TOC]</sup>](#gui-tools-nbspsuptocsup)
      - [:black_small_square: Network](#black_small_square-network)
      - [:black_small_square: Browsers](#black_small_square-browsers)
      - [:black_small_square: Password Managers](#black_small_square-password-managers)
      - [:black_small_square: Messengers/IRC Clients](#black_small_square-messengersirc-clients-1)
      - [:black_small_square: Messengers (end-to-end encryption)](#black_small_square-messengers-end-to-end-encryption)
      - [:black_small_square: Text editors](#black_small_square-text-editors)
    - [Web Tools &nbsp<sup>[TOC]</sup>](#web-tools-nbspsuptocsup)
      - [:black_small_square: Browsers](#black_small_square-browsers-1)
      - [:black_small_square: HTTP Headers & Web Linters](#black_small_square-http-headers--web-linters)
      - [:black_small_square: DNS](#black_small_square-dns)
      - [:black_small_square: Mail](#black_small_square-mail)
      - [:black_small_square: Encoders/Decoders and Regex testing](#black_small_square-encodersdecoders-and-regex-testing)
      - [:black_small_square: Privacy](#black_small_square-privacy)
      - [:black_small_square: Code parsers/playgrounds](#black_small_square-code-parsersplaygrounds)
      - [:black_small_square: Performance](#black_small_square-performance)
      - [:black_small_square: Mass scanners (search engines)](#black_small_square-mass-scanners-search-engines)
      - [:black_small_square: Generators](#black_small_square-generators)
      - [:black_small_square: Passwords](#black_small_square-passwords)
      - [:black_small_square: CVE/Exploits databases](#black_small_square-cveexploits-databases)
      - [:black_small_square: Mobile apps scanners](#black_small_square-mobile-apps-scanners)
      - [:black_small_square: Private Search Engines](#black_small_square-private-search-engines)
      - [:black_small_square: Secure Webmail Providers](#black_small_square-secure-webmail-providers)
      - [:black_small_square: Crypto](#black_small_square-crypto)
      - [:black_small_square: PGP Keyservers](#black_small_square-pgp-keyservers)
    - [Systems/Services &nbsp<sup>[TOC]</sup>](#systemsservices-nbspsuptocsup)
      - [:black_small_square: Operating Systems](#black_small_square-operating-systems)
      - [:black_small_square: HTTP(s) Services](#black_small_square-https-services)
      - [:black_small_square: DNS Services](#black_small_square-dns-services)
      - [:black_small_square: Other Services](#black_small_square-other-services)
      - [:black_small_square: Security/hardening](#black_small_square-securityhardening)
    - [Networks &nbsp<sup>[TOC]</sup>](#networks-nbspsuptocsup)
      - [:black_small_square: Tools](#black_small_square-tools)
      - [:black_small_square: Labs](#black_small_square-labs)
      - [:black_small_square: Other](#black_small_square-other-1)
    - [Containers/Orchestration &nbsp<sup>[TOC]</sup>](#containersorchestration-nbspsuptocsup)
      - [:black_small_square: CLI Tools](#black_small_square-cli-tools)
      - [:black_small_square: Web Tools](#black_small_square-web-tools)
      - [:black_small_square: Security](#black_small_square-security-1)
      - [:black_small_square: Manuals/Tutorials/Best Practices](#black_small_square-manualstutorialsbest-practices)
    - [Manuals/Howtos/Tutorials &nbsp<sup>[TOC]</sup>](#manualshowtostutorials-nbspsuptocsup)
      - [:black_small_square: Shell/Command line](#black_small_square-shellcommand-line)
      - [:black_small_square: Text Editors](#black_small_square-text-editors)
      - [:black_small_square: Python](#black_small_square-python)
      - [:black_small_square: Sed & Awk & Other](#black_small_square-sed--awk--other)
      - [:black_small_square: \*nix & Network](#black_small_square-nix--network)
      - [:black_small_square: Microsoft](#black_small_square-microsoft)
      - [:black_small_square: Large-scale systems](#black_small_square-large-scale-systems)
      - [:black_small_square: System hardening](#black_small_square-system-hardening)
      - [:black_small_square: Security & Privacy](#black_small_square-security--privacy)
      - [:black_small_square: Web Apps](#black_small_square-web-apps)
      - [:black_small_square: All-in-one](#black_small_square-all-in-one)
      - [:black_small_square: Ebooks](#black_small_square-ebooks)
      - [:black_small_square: Other](#black_small_square-other-2)
    - [Inspiring Lists &nbsp<sup>[TOC]</sup>](#inspiring-lists-nbspsuptocsup)
      - [:black_small_square: SysOps/DevOps](#black_small_square-sysopsdevops)
      - [:black_small_square: Developers](#black_small_square-developers)
      - [:black_small_square: Security/Pentesting](#black_small_square-securitypentesting)
      - [:black_small_square: Other](#black_small_square-other-3)
    - [Blogs/Podcasts/Videos &nbsp<sup>[TOC]</sup>](#blogspodcastsvideos-nbspsuptocsup)
      - [:black_small_square: SysOps/DevOps](#black_small_square-sysopsdevops-1)
      - [:black_small_square: Developers](#black_small_square-developers-1)
      - [:black_small_square: Geeky Persons](#black_small_square-geeky-persons)
      - [:black_small_square: Geeky Blogs](#black_small_square-geeky-blogs)
      - [:black_small_square: Geeky Vendor Blogs](#black_small_square-geeky-vendor-blogs)
      - [:black_small_square: Geeky Cybersecurity Podcasts](#black_small_square-geeky-cybersecurity-podcasts)
      - [:black_small_square: Geeky Cybersecurity Video Blogs](#black_small_square-geeky-cybersecurity-video-blogs)
      - [:black_small_square: Best Personal Twitter Accounts](#black_small_square-best-personal-twitter-accounts)
      - [:black_small_square: Best Commercial Twitter Accounts](#black_small_square-best-commercial-twitter-accounts)
      - [:black_small_square: A piece of history](#black_small_square-a-piece-of-history)
      - [:black_small_square: Other](#black_small_square-other-4)
    - [Hacking/Penetration Testing &nbsp<sup>[TOC]</sup>](#hackingpenetration-testing-nbspsuptocsup)
      - [:black_small_square: Pentesters arsenal tools](#black_small_square-pentesters-arsenal-tools)
      - [:black_small_square: Pentests bookmarks collection](#black_small_square-pentests-bookmarks-collection)
      - [:black_small_square: Backdoors/exploits](#black_small_square-backdoorsexploits)
      - [:black_small_square: Wordlists and Weak passwords](#black_small_square-wordlists-and-weak-passwords)
      - [:black_small_square: Bounty platforms](#black_small_square-bounty-platforms)
      - [:black_small_square: Web Training Apps (local installation)](#black_small_square-web-training-apps-local-installation)
      - [:black_small_square: Labs (ethical hacking platforms/trainings/CTFs)](#black_small_square-labs-ethical-hacking-platformstrainingsctfs)
      - [:black_small_square: CTF platforms](#black_small_square-ctf-platforms)
      - [:black_small_square: Other resources](#black_small_square-other-resources)
    - [Your daily knowledge and news &nbsp<sup>[TOC]</sup>](#your-daily-knowledge-and-news-nbspsuptocsup)
      - [:black_small_square: RSS Readers](#black_small_square-rss-readers)
      - [:black_small_square: IRC Channels](#black_small_square-irc-channels)
      - [:black_small_square: Security](#black_small_square-security-2)
      - [:black_small_square: Other/All-in-one](#black_small_square-otherall-in-one)
    - [Other Cheat Sheets &nbsp<sup>[TOC]</sup>](#other-cheat-sheets-nbspsuptocsup)
        ...
        - [Build your own System/Virtual Machine](#build-your-own-systemvirtual-machine)
